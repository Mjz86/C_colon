...
addressed/unaddressed/unaddressable,


an unaddressable memory region cannot be pointed to by any pointer or reference, 
an unaddressed memory region   is  never pointed to by any pointer or reference while the qualifier is present, 
an addressed memory region  may have pointers poining to it.
